...
zone_map = {
    ...
    1: {
        ...
        1: {
            ...
            DESCRIPTION: "You step through the front door of your small, cozy wooden house and are greeted by the "
            ...
            'ITEMS': {
                0: {
                    ITEM_NAME: 'Bed',
                    ITEM_DESC: "The bed is the centerpiece of the cozy bedroom, and it looks incredibly comfortable. "
                ...
                1: {
                    ITEM_NAME: 'Lamp',
                    ITEM_DESC: "The lamp is small but stylish, with a sleek silver base and a frosted glass shade. It "
